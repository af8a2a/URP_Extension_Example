...
namespace Features.AO.GTAO
{
    ...
    {
        [CustomEditor(typeof(GroundTruthAmbientOcclusion))]
        internal class GroundTruthAmbientOcclusionEditor : Editor
        {
            ...
            private struct Styles
            {
                ...
                public static GUIContent DirectLightingStrength =
                    EditorGUIUtility.TrTextContent("Direct Lighting Strength",
            ...
            public override void OnInspectorGUI()
            {
                ...
                GUI.enabled = !isDeferredRenderingMode && m_Source.enumValueIndex ==
                    (int)ScreenSpaceAmbientOcclusionSettings.DepthSource.Depth;
