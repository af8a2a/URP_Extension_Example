...
namespace URP_Extension.Features.ScreenSpaceRaytracing.StochasticScreenSpaceReflection
{
    ...
    public class StochasticScreenSpaceReflection : VolumeComponent, IPostProcessComponent
    {
        ...
        {
            get { return m_MinSmoothness.value; }
        ...
        {
            get { return m_SmoothnessFadeStart.value; }
        ...
        /// </summary>
        [AdditionalProperty] public ClampedFloatParameter biasFactor = new ClampedFloatParameter(0.0f, 0.0f, 1.0f);
        ...
        {
            get { return m_RayMaxIterations.value; }
        ...
        [SerializeField, FormerlySerializedAs("denoise")] [Tooltip("Denoise the ray-traced reflection.")]
        ...
        {
            get { return m_AffectSmoothSurfaces.value; }
            set { m_AffectSmoothSurfaces.value = value; }
        }

        [SerializeField] [Tooltip("Denoiser affects smooth surfaces.")]
        ...
        {
            get { return m_RayMaxIterationsRT.value; }
